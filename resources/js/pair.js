...
var Pair = function() {
    ...
    this.render = function(ctx, cw, ch, colors) {
        ...
        imgA.src = `../puyo/puyo_${colors[a.color]}.png`;
        ctx.drawImage(imgA, a.x * cw + r1, (a.y - 1) * ch + r2, 30, 30);
        //ctx.fillStyle = colors[a.color];

        const imgB = new Image()
        imgB.src = `../puyo/puyo_${colors[b.color]}.png`;
        ctx.drawImage(imgB, b.x * cw + r1, (b.y - 1) * ch + r2, 30, 30);
